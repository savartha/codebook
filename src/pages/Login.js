...
export const Login = () => {
    ...
    async function handleLoginGuest(){
      email.current.value = process.env.REACT_APP_LOGIN;
      pwd.current.value = process.env.REACT_APP_PWD
      const authDetails = {
        email:email.current.value,
        password:pwd.current.value
      } 
          ...
          <section>
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="mb-6">
                  ...
                  <input ref={pwd} type="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
              </div>
